...
export const NAV_ITEMS = [
  ...
  { name: 'What-if Sandbox', path: '/sandbox', icon: SlidersHorizontal, blurb: 'Move a lever, re-solve', role: 'ADMIN' },
  ...
  { name: 'Scenarios', path: '/scenarios', icon: Fuel, blurb: 'Fuel transition planning', role: 'ADMIN' },
  { name: 'Benchmarks', path: '/benchmarks', icon: BarChart3, blurb: 'Algorithm evidence', role: 'ADMIN' },
  {
    name: 'Employees',
    path: '/admin',
    icon: Users,
